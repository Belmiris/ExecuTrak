...
Public Const szSignedLongIntPattern As String = "^((\-)?(#{0,9}|[0-1]#{0,9}|\2(\0#{0,8}|\1([0-3]#{0,7}|\4([0-6]#{0,6}|\7([0-3]#{0,5}|\4([0-7]#{0,4}|\8([0-2]#{0,3}|\3([0-5]#?#?|\6([0-3]#?|\4[0-7]?)?)?)?)?)?)?)?)?))$"
' Dan 4/22/04 is adding szSignedLongIntPatter per #425206 to allow for negative values
