...
Public Function fnLockP_Checks_old(ByVal sPGrp As String, _
    ...
    If lRecCount < 0 Then
        fnLockP_Checks_old = QUERY_FAILED
        Exit Function
    ElseIf lRecCount = 0 Then
        fnLockP_Checks_old = "Invalid Print Group"
        Exit Function
    End If
    ...
    Else
        ...
        If lRecCount < 0 Then
             ...
             Exit Function
        ElseIf lRecCount = 0 Then
            fnLockP_Checks_old = "No records found for payment"
            Exit Function
        End If
     ...
     Else
        ...
        End If
        If lRecCount > 0 Then
            fnLockP_Checks_old = "Check # " & tfnRound(rsTemp!pv_check_nbr) & " is used; it falls between start and end numbers"
            Exit Function
        End If
        ...
        If apc_GetRecordSet(rsTemp, strSQL) > 0 Then
            fnLockP_Checks_old = "Check # " & tfnRound(Right(Trim(rsTemp!srl_criteria & ""), 10)) & " is locked; it falls between start and end numbers"
            Exit Function
        End If
    End If
    '#Lock the Checks
    ...
    fnLockP_Checks_old = szEMPTY
    Exit Function
errTrap:
    fnLockP_Checks_old = "Error: " & Err.Description
End Function
...
Public Function fnLockP_Checks2(ByVal sPGrp As String, _
                                ByVal sUser As String, _
                                ByRef lStart As Long, _
                                ByRef lCount As Long) As String
    Const QUERY_FAILED = "SQL query failed. Contact Factor"
    Const TableName = "p_checks"
    Dim strSQL As String
    Dim sTemp As String
    ...
    lRecCount = apc_GetRecordSet(rsTemp, strSQL)
    If lRecCount < 0 Then
        fnLockP_Checks2 = QUERY_FAILED
        Exit Function
    ElseIf lRecCount = 0 Then
        fnLockP_Checks2 = "Invalid Print Group"
        Exit Function
    End If
    ...
    End If
    If lRecCount > 0 Then
        fnLockP_Checks2 = "Check # " & tfnRound(rsTemp!pv_check_nbr) & " is used; it falls between start and end numbers"
        Exit Function
    End If
    ...
    strSQL = strSQL & " AND '" & fnFormatPCheck(sChkAcct, lEnd) & "'"
    If apc_GetRecordSet(rsTemp, strSQL) > 0 Then
        fnLockP_Checks2 = "Check # " & tfnRound(Right(Trim(rsTemp!srl_criteria & ""), 10)) & " is locked; it falls between start and end numbers"
        Exit Function
    End If
    ...
    fnLockP_Checks2 = szEMPTY
    Exit Function
    
errTrap:
    fnLockP_Checks2 = "Error: " & Err.Description
End Function
...
Public Function fnLockP_Checks(ByVal sPGrp As String, _
    ...
    fnLockP_Checks = fnLockP_Checks2(sPGrp, sUser, lStart, lNumberChecks)
    If fnLockP_Checks <> szEMPTY Then
        Exit Function
    End If
...
Public Function fnGenerateCheckNumber(ByVal sPGrp As String, _
                                ByVal sUser As String) As Long
    Const QUERY_FAILED = "SQL query failed. Contact Factor"
    Const TableName = "p_checks"
    Dim strSQL As String
    Dim sTemp As String
